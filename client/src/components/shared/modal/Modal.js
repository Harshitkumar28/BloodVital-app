    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
        <div className="d-flex mb-3">
            ...
            <div className="form-check ms-3">
                <input type="radio" name="inradio"  value={'out'} 
                // name should be same means inradio in both in and out to select only one each time
                onChange={(e)=> setInventoryType(e.target.value)} className="form-check-input" />
...
/>
<InputType labelText={'Quantity in mL'} labelFor= {'quantity'} inputType={'Number'}
value={quantity}
