  ...
  return (
    <div>
        <form onSubmit={(e)=>{
            ...
            else if(formType === 'register') return handleRegister(e,name,role,email,password,organisation,address,phone,hospitalName,website)
        }}>
            <h1 className="text-center">{formTitle}</h1>
            <hr />
            <div className="d-flex mb-3">
                {/* d-flex is a class of bootstrap  */}
                <div className="form-check">
                    <input type="radio" className="form-check-input" name="role"
                    id="donarRadio" value={'donar'} onChange={(e)=>setRole(e.target.value)} defaultChecked></input>
                ...
                <div className="form-check ms-2">
                    <input type="radio" className="form-check-input" name="role"
                    id="adminRadio" value={'admin'} onChange={(e)=>setRole(e.target.value)} ></input>
                ...
                <div className="form-check ms-2">
                    <input type="radio" className="form-check-input" name="role"
                    id="hospitalRadio" value={'hospital'} onChange={(e)=>setRole(e.target.value)}></input>
                ...
                <div className="form-check ms-2">
                    <input type="radio" className="form-check-input" name="role"
                    id="organisationRadio" value={'organisation'} onChange={(e)=>setRole(e.target.value)}></input>
...
/>
                    ...
                    case formType === 'register':{
                      return (
                        ...
                        {(role === 'organisation') && (
                            <InputType labelText = {'Organisation Name'} labelFor={'fororganisation'} inputType={'text'} name={'organisation'}
                            value = {organisation} 
